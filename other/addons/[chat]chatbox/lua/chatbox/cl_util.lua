...
File Path:   addons/[chat]_sh_lounge_chatbox/lua/chatbox/cl_util.lua
...
function LOUNGE_CHAT:DrawCharacterAvatar( player, siz, par )
	...
	if ( ents.FindByClassAndParent( "ent_bonemerged", player ) ) then
		...
		for i = 1, #tbl_bonemerged do
		    ...
		    charav:BoneMerged(bonemerge:GetModel(), bonemerge:GetSubMaterial(0), bonemerge:GetInvisible())
