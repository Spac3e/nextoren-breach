...
File Path:   gamemodes/breach/entities/weapons/hacking_doors.lua
...
function SWEP:PrimaryAttack()
	...
	self.Owner:BrProgressBar( "Взламывание...", time, "nextoren/gui/icons/hacker_hack.png", ent, false, function()
		...
		end, function() self:SendWeaponAnim( ACT_VM_IDLE ) end)
end
