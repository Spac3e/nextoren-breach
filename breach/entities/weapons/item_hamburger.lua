    ...
    if ( SERVER ) then
      ...
      if ( self && self:IsValid() ) then
        ...
        if ( self.Owner:GetNClass():find( "Fat" ) ) then
          ...
          self.Owner:BrTip( 0, "[RX Breach]", Color(255,0,0, 210), "Вы съели бургер. Здоровье полностью восстановлено.", color_white )
          ...
          self.Owner:BrTip( 0, "[RX Breach]", Color(255,0,0, 210), "Вы съели бургер. Восполнено " .. show_health .. " здоровья.", color_white )
