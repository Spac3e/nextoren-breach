...
File Path:   gamemodes/breach/entities/entities/projectile_scp_009.lua
...
if SERVER then
	...
	function mply:Make009Statue()
		...
		self:AddToStatistics("SCP-009 Death", -100)
		self:LevelBar()
...
function ENT:PhysicsCollide(entity)
	...
	for i, v in pairs(Ents) do
		...
		if v:IsPlayer() and self:IsSeen(v) and v:GTeam() != TEAM_SPEC and v:GTeam() != TEAM_SCP and !v:HasHazmat() and (v:GTeam() != TEAM_GOC or v:GetNClass():find("spy")) then
