...
ROLES.ROLE_SCI_ASSISTANT = "Assistant"
ROLES.ROLE_SCI_CLEANER = "Cleaner"
ROLES.ROLE_SCI_RES = "Researcher"
ROLES.ROLE_SCI_TESTER = "Tester"
ROLES.ROLE_SCI_MEDIC = "Medic"
ROLES.ROLE_SCI_HEAD = "Head of Science Personnel"
...
// Секурете
ROLES.ROLE_SECURITYRECRUIT = "Security Rookie"
ROLES.ROLE_SECURITYSERG = "Security Sergeant"
ROLES.ROLE_SECURITYOFFICER = "Security Officer"
ROLES.ROLE_SECURITYWARDEN = "Security Warden"
ROLES.ROLE_SECURITYSTORMTROOPER = "Security Shock trooper"
ROLES.ROLE_SECURITYIMV = "Security Specialist"
ROLES.ROLE_SECURITYCHIEF = "Security Chief"
ROLES.ROLE_SECURITYSPY = "CI Spy"
...
if !ConVarExists("br_rounds") then CreateConVar("br_rounds", "10", {FCVAR_SERVER_CAN_EXECUTE, FCVAR_ARCHIVE}, "How many round before map restart? 0 - dont restart" ) end
...
function GM:ShouldCollide( ent1, ent2 )
		...
		if ent1:IsPlayer() and ent1:GTeam() == TEAM_SCP or ent2:IsPlayer() and ent2:GTeam() == TEAM_SCP then
			if ( ent1_class == "func_door"
				...
				if (ent1:IsPlayer() and ent1:GetNClass() == SCP096 and ent1:GetWalkSpeed() != 40 ) or (ent2:IsPlayer() and ent2:GetNClass() == SCP096 and ent2:GetWalkSpeed() != 40) then
