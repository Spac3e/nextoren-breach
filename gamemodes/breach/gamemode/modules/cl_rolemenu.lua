...
if LocalPlayer():GTeam() != TEAM_SPEC then
	...
	local faction_table = {
		...
		[ 3 ] = { name = clang.DZ, icon = "nextoren/gui/roles_icon/dz.png", class_d = "Враг", roles = BREACH_ROLES.DZ, chaos = "Враг", gru = "Враг", dz = "Союзник", uiu = "Враг", goc = "Враг", sci = "Враг", sb = "Враг", mog = "Враг", obr = "Враг", scp = "Союзник", ntf = "Враг", Desc = "l:f2_dz" },
		[ 4 ] = { name = clang.UIU, icon = "nextoren/gui/roles_icon/fbi.png", roles = BREACH_ROLES.FBI, class_d = "Нейтралитет", chaos = "Враг", gru = "Враг", dz = "Враг", uiu = "Союзник", goc = "Враг", sci = "Нейтралитет", sb = "Враг", mog = "Враг", obr = "Враг", scp = "Враг", ntf = "Враг", Desc = "l:f2_uiu" },
		[ 5 ] = { name = clang.Goc, icon = "nextoren/gui/roles_icon/goc.png", roles = BREACH_ROLES.GOC, class_d = "Враг", chaos = "Враг", gru = "Враг", dz = "Враг", uiu = "Враг", goc = "Союзник", sci = "Враг", sb = "Враг", mog = "Враг", obr = "Враг", scp = "Враг", ntf = "Враг", Desc = "l:f2_goc" },
		[ 6 ] = { name = clang.SCI, icon = "nextoren/gui/roles_icon/sci.png", roles = BREACH_ROLES.SCI, class_d = "Нейтралитет", chaos = "Враг", gru = "Нейтралитет", dz = "Враг", uiu = "Нейтралитет", goc = "Враг", sci = "Союзник", sb = "Союзник", mog = "Союзник", obr = "Союзник", scp = "Враг", ntf = "Союзник", Desc = "l:f2_sci" },
		[ 7 ] = { name = clang.SCI_SPECIAL, icon = "nextoren/gui/roles_icon/sci_special.png", roles = BREACH_ROLES.SPECIAL, class_d = "Нейтралитет", chaos = "Враг", gru = "Нейтралитет", dz = "Враг", uiu = "Нейтралитет", goc = "Враг", sci = "Союзник", sb = "Союзник", mog = "Союзник", obr = "Союзник", scp = "Враг", ntf = "Союзник", Desc = "l:f2_sci" },
		[ 8 ] = { name = clang.SECURITY, icon = "nextoren/gui/roles_icon/sb.png", roles = BREACH_ROLES.SECURITY, class_d = "Нейтралитет", chaos = "Враг", gru = "Нейтралитет", dz = "Враг", uiu = "Враг", goc = "Враг", sci = "Союзник", sb = "Союзник", mog = "Союзник", obr = "Союзник", scp = "Враг", ntf = "Союзник", Desc = "l:f2_security" },
		[ 9 ] = { name = clang.MTF, icon = "nextoren/gui/roles_icon/mtf.png", roles = BREACH_ROLES.MTF, class_d = "Враг", chaos = "Враг", gru = "Нейтралитет", dz = "Враг", uiu = "Враг", goc = "Враг", sci = "Союзник", sb = "Союзник", mog = "Союзник", obr = "Союзник", scp = "Враг", ntf = "Союзник", Desc = "l:f2_mtf" },
		--[ 10 ] = { name = clang.OSN, icon = "nextoren/gui/roles_icon/osn.png", roles = BREACH_ROLES.OSN, class_d = "Враг", chaos = "Враг", gru = "Нейтралитет", dz = "Враг", uiu = "Враг", goc = "Враг", sci = "Союзник", sb = "Союзник", mog = "Союзник", obr = "Союзник", scp = "Враг", ntf = "Союзник", Desc = "l:f2_osn" },
		[ 10 ] = { name = clang.QRT, icon = "nextoren/gui/roles_icon/obr.png", roles = BREACH_ROLES.OBR, class_d = "Враг", chaos = "Враг", gru = "Нейтралитет", dz = "Враг", uiu = "Враг", goc = "Враг", sci = "Союзник", sb = "Союзник", mog = "Союзник", obr = "Союзник", scp = "Враг", ntf = "Союзник", Desc = "l:f2_qrt" },
		[ 11 ] = { name = clang.ClassD, icon = "nextoren/gui/roles_icon/class_d.png", roles = BREACH_ROLES.CLASSD, class_d = "Союзник", chaos = "Союзник", gru = "Нейтралитет", dz = "Враг", uiu = "Враг", goc = "Враг", sci = "Нейтралитет", sb = "Нейтралитет", mog = "Враг", obr = "Враг", scp = "Враг", ntf = "Враг", Desc = "l:f2_classd" },
		--[ 12 ] = { name = clang.Cult, icon = "nextoren/gui/roles_icon/scarlet.png", roles = BREACH_ROLES.COTSK, class_d = "Враг", chaos = "Враг", gru = "Враг", dz = "Враг", uiu = "Враг", goc = "Враг", sci = "Враг", sb = "Враг", mog = "Враг", obr = "Враг", scp = "Враг", ntf = "Враг", Desc = "l:f2_cult" },
		[ 12 ] = { name = "SCP", icon = "nextoren/gui/roles_icon/scp.png", roles = BREACH_ROLES.SCP, class_d = "Враг", chaos = "Враг", gru = "Враг", dz = "Союзник", uiu = "Враг", goc = "Враг", sci = "Враг", sb = "Враг", mog = "Враг", obr = "Враг", scp = "Союзник", ntf = "Враг", Desc = "l:f2_scp" },
		...
		--[ 16 ] = { name = clang.SKP, icon = "nextoren/gui/roles_icon/nazi.png", roles = BREACH_ROLES.NAZI, class_d = "Враг", chaos = "Враг", gru = "Враг", dz = "Враг", uiu = "Враг", goc = "Враг", sci = "Враг", sb = "Враг", mog = "Враг", obr = "Враг", scp = "Враг", ntf = "Враг", Desc = "l:f2_skp" }
