...
if LocalPlayer():GTeam() != TEAM_SPEC then
	...
	local faction_table = {
		...
		--[ 15 ] = { name = clang.SKP, icon = "nextoren/gui/roles_icon/nazi.png", roles = BREACH_ROLES.NAZI, class_d = "Враг", chaos = "Враг", gru = "Враг", dz = "Враг", uiu = "Враг", goc = "Враг", sci = "Враг", sb = "Враг", mog = "Враг", obr = "Враг", scp = "Враг", ntf = "Враг", Desc = "l:f2_skp" }
