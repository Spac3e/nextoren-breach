...
net.Receive("Boom_Effectus", function()
    ...
    PlayAnnouncer("nextoren/ending/nuke.mp3")
...
net.Receive( "3DSoundPosition", function()
	local snd_string = net.ReadString()
	local pos = net.ReadVector()
	local volume = net.ReadUInt(4)
  
  	sound.PlayFile( snd_string, "noplay 3d", function( station )
