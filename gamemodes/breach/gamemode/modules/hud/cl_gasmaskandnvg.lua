...
for _, v in pairs( BUTTONS ) do
    ...
    if ( !position ) then continue end

    if ( position:DistToSqr( LocalPlayer():GetPos() ) > 10000 * 1000 ) then continue end
    ...
    DrawTheText( "Button "..v.name, pos.x, pos.y, Color( 255, 255, 0 ), "HUDFont" )

    if v.access and v.access.CLevel then
    DrawTheText( "CLevel: " ..v.access.CLevel, pos.x, pos.y - 16, Color( 255, 255, 0 ), "HUDFont" )
    end
    
    if (v.access and v.access.CLevelSCI && v.access.CLevelGuard && v.access.CLevelMTF && v.access.CLevelSUP ) then


      DrawTheText( "CLevel SCI: "..v.access.CLevelSCI, pos.x, pos.y + 16, Color( 255, 255, 0 ), "HUDFont" )



      DrawTheText( "CLevel Guard: "..v.access.CLevelGuard, pos.x, pos.y + 32, Color( 255, 255, 0 ), "HUDFont" )



      DrawTheText( "CLevel MTF: "..v.access.CLevelMTF, pos.x, pos.y + 48, Color( 255, 255, 0 ), "HUDFont" )



      DrawTheText( "CLevel SUP: "..v.access.CLevelSUP, pos.x, pos.y + 64, Color( 255, 255, 0 ), "HUDFont" )



    end

    if v.allowed_keycards and v.allowed_keycards != "" and v.allowed_keycards != nil then
      DrawTheText( "Allowed Keycard", pos.x, pos.y + 76, Color( 255, 255, 0 ), "HUDFont" )
    end
