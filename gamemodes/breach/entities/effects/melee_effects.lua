...
BREACH_LASTCOLOR = BREACH_LASTCOLOR || Color( 0, 0, 0, 0 )
...
function EFFECT:Init( data )
  ...
  --print( self.HitMat )
  ----print( self.HitGroup == HITGROUP_HEAD, " HitBox" )

  --self.Flags = data:GetFlags()
  self.HitColor = renderGetSurfaceColor( self.Pos + self.Dir1 * 2, self.Pos - self.Dir1 * 2 ):ToColor()
  ...
  --[[if ( self.HitColor.r < 32 || self.HitColor.g < 32 || self.HitColor.b < 32 ) then

    if ( self.HitColor.r < 8 && self.HitColor.g < 8 && self.HitColor.b < 8 ) then
  ...
  if ( self.BulletType > 6000 && Mode == BREACH_BULLET_IMPACT ) then
    ...
    if ( self.Caliber >= 70 ) then
      ...
      --util.Decal( "Scorch", self.Pos - self.Dir1, self.Pos + self.Dir1 )
  ...
  elseif ( Mode == BREACH_BULLET_PENETRATE ) then
    ...
    if ( self.Caliber > 30 ) then
      ...
      if ( dist <= 2000 && typedebris[hiteffect] )then
...
function EFFECT:CreateEffects()
  ...
  if ( self.HitEnt && self.HitEnt:IsValid() && self.HitEnt:GetClass() == "prop_ragdoll" || self.HitEnt:IsPlayer() ) then
  ...
  --if ( self.HitMat != 1 ) then return end
  ...
  if ( self.HitEnt && self.HitEnt:IsValid() && self.HitEnt:GetModel() == "models/cultist/scp/173.mdl" ) then
