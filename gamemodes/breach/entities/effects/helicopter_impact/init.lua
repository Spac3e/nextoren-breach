...
File Path:   gamemodes/breach/entities/effects/helicopter_impact/init.lua
...
function EFFECT:Init( data )
  ...
  for i = 0, 360, 10 do
    ...
    --[[particle = self.emitter:Add( "particle/flamelet"..math.random( 1, 5 ), self.vOffset + normal * scale / 20 )
