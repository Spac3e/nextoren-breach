...
hook.Add( "KeyPress", "KeyPressForRagdoll", function( ply, key )
	...
	elseif ( key == IN_USE ) then
		...
		ply:BrProgressBar("l:looting_body", 6, "nextoren/gui/icons/notifications/breachiconfortips.png", nil, true, function()
			...
			--BREACH.Players:ChatPrint( ply, true, true, "Вы обыскали тело " .. self:GetNamesurvivor() )
